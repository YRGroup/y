<template>
  <div>
    ...
    <group title="家长">     
      <cell :title="i.ParentType" :inline-desc="i.ParentTrueName" :value="i.ParentPhone" v-for="i in data.Parents"></cell>
    </group>
    <group title="基本资料"> 
    ...
    <div class="editbtn">
      <x-button text="修改资料" type="warn" @click.native="$router.push('/student/'+$route.params.studentId+'/edit')"></x-button>
    </div>
