window.Swipe = function (a, b) {
    ...
    Swipe.prototype = {
        setup: function () {
            ...
            this.width = this.container.getBoundingClientRect().width||window.innerWidth;
            if (!this.width) {
                return null
            }
        ...
        slide: function (a, b) {
            a=parseInt(a);
            // if(a>2){
            //     if(window.parent.$('#edu .zuoye').hasClass('active')){
            //         a=2;
            //     }else if(window.parent.$('#edu .liaotian').hasClass('active')){
            //         a=1;
            //     }else {
            //         a=0;
            //     }
        ...
        onTouchMove: function (a) {
            if (!this.disableScroll) {
                ...
                this.isScrolling || (a.preventDefault(), clearTimeout(this.interval), this.deltaX = this.deltaX / (!this.index && this.deltaX > 0 || this.index == this.length - 1 && this.deltaX < 0 ? Math.abs(this.deltaX) / this.width + 1 : 1), this.element.style.webkitTransform = "translate3d(" + (this.deltaX - this.index * this.width) + "px,0,0)")
            }
        },
